 ...
 * Runs a background worker thread that continuously generates live Digital Twin sensor telemetry.
 */
@Service
public class CampusSimulationWorker implements Runnable {
    ...
    public void startWorker() {
        ...
        workerThread.start();
        logger.info("Campus Digital Twin Concurrency Worker Thread started successfully.");
    }
